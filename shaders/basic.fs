...
void main() {
    ...
    float perlin_noise = noise(vsoTexCoord * frequency);
    ...
    vec3 color = vec3(perlin_noise + simplex_noise*3, perlin_noise + simplex_noise*3.0, perlin_noise + simplex_noise*3); 
